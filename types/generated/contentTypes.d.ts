...
export interface ApiActionModeActionMode extends Struct.CollectionTypeSchema {
...
export interface ApiActiveIngredientActiveIngredient
  ...
  attributes: {
    chemical_group: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiChemicalGroupChemicalGroup
  extends Struct.CollectionTypeSchema {
...
export interface ApiCompanyTypeCompanyType extends Struct.CollectionTypeSchema {
...
export interface ApiFormulationFormulation extends Struct.CollectionTypeSchema {
...
export interface ApiPragueCommonNamePragueCommonName
  ...
  attributes: {
    ...
    prague: Schema.Attribute.Relation<'manyToOne', 'api::prague.prague'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPraguePrague extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    prague_common_names: Schema.Attribute.Relation<
      'oneToMany',
      'api::prague-common-name.prague-common-name'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductActionModeProductActionMode
  ...
  attributes: {
    action_mode: Schema.Attribute.Relation<
      'oneToOne',
      'api::action-mode.action-mode'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProductActiveIngredientProductActiveIngredient
  ...
  attributes: {
    active_ingredient: Schema.Attribute.Relation<
      'oneToOne',
      'api::active-ingredient.active-ingredient'
    >;
    concentration: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductClassProductClass
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action_mechanism: Schema.Attribute.Relation<
      'oneToOne',
      'api::action-mechanism.action-mechanism'
    >;
...
export interface ApiProductCompanyProductCompany
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    company_type: Schema.Attribute.Relation<
      'oneToOne',
      'api::company-type.company-type'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProductCultureProductCulture
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    culture: Schema.Attribute.Relation<'oneToOne', 'api::culture.culture'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductPragueProductPrague
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    prague: Schema.Attribute.Relation<'oneToOne', 'api::prague.prague'>;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    environmental_class: Schema.Attribute.Relation<
      'oneToOne',
      'api::environmental-class.environmental-class'
    >;
    formulation: Schema.Attribute.Relation<
      'oneToOne',
      'api::formulation.formulation'
    >;
    hrac: Schema.Attribute.String;
    is_active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    is_organic: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    product_action_modes: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-action-mode.product-action-mode'
    >;
    product_active_ingredients: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-active-ingredient.product-active-ingredient'
    >;
    product_brands: Schema.Attribute.Relation<
      ...
      'api::product-brand.product-brand'
    >;
    product_classes: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-class.product-class'
    >;
    product_companies: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-company.product-company'
    >;
    product_cultures: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-culture.product-culture'
    >;
    product_pragues: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-prague.product-prague'
    >;
    publishedAt: Schema.Attribute.DateTime;
    reference_id: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    register_number: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    registration_holder: Schema.Attribute.Relation<
      'oneToOne',
      'api::registration-holder.registration-holder'
    >;
    toxicological_class: Schema.Attribute.Relation<
      'oneToOne',
